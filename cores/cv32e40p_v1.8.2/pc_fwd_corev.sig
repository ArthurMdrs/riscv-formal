...
<wavelist version="3">
  <insertion-point-position>48</insertion-point-position>
  <wave>
    <expr>clock</expr>
    <label/>
    <radix/>
  ...
  <group collapsed="false">
    ...
    <wave collapsed="true">
      <expr>wrapper.core_top_i.core_i.rvfi_order_wb</expr>
      <label/>
      <radix/>
    </wave>
    <wave collapsed="true">
      <expr>wrapper.core_top_i.core_i.rvfi_order</expr>
      <label/>
      <radix/>
    </wave>
    <wave>
  ...
  <wave>
    <expr>wrapper.core_top_i.core_i.if_stage_i.aligner_i.branch_i</expr>
    <label/>
    <radix/>
  </wave>
  <wave>
    <expr>wrapper.core_top_i.core_i.id_stage_i.controller_i.branch_taken_ex_i</expr>
    <label/>
    <radix/>
  </wave>
  <wave>
    <expr>wrapper.core_top_i.core_i.id_stage_i.controller_i.is_decoding_o</expr>
    <label/>
    <radix/>
  </wave>
  ...
  <group collapsed="false">
    ...
    <wave>
      ...
      <label/>
      <radix>wrapper.core_top_i.core_i.if_stage_i.instr_decompressed</radix>
    </wave>
    <wave>

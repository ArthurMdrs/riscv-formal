...
def gen_tcl_str(incdirs_vec, sv_files_vec, check_ch):
    tcl_str = "clear -all\n\nanalyze -sv12 \\\n"
...
#         if re.search(r'\[.*\]', line):
#             checks_start = False
#         if checks_start and line.strip()!='':
#             # checks_vec.append(line.split()[0])
#             item = line.split()[0]
#             item = replace_string(item, "@basedir@/cores/@core@", coredir)
#             item = replace_string(item, "@basedir@", basedir)
#             item = replace_string(item, "@core@", corename)
#             checks_vec.append(item)
#         if '[depth]' in line:
#             checks_start = True
...
#         if re.search(r'\[.*\]', line):
#             sv_start = False
#         if sv_start and line.strip()!='':
#             item = line.split()[0]
#             item = replace_string(item, "@basedir@/cores/@core@", coredir)
#             item = replace_string(item, "@basedir@", basedir)
#             item = replace_string(item, "@core@", corename)
#             sv_files_vec.append(item)
#         if '[verilog-files]' in line:
#             sv_start = True
...
#         if re.search(r'\[.*\]', line):
#             incdirs_start = False
#         if incdirs_start and line.strip()!='':
#             item = line.split()[0]
#             item = replace_string(item, "@basedir@/cores/@core@", coredir)
#             item = replace_string(item, "@basedir@", basedir)
#             item = replace_string(item, "@core@", corename)
#             incdirs_vec.append(item)
#         if '[incdirs]' in line:
#             incdirs_start = True
...
for check in checks_vec:
    for ch in range(0, nret):
        ...
        tcl_str = gen_tcl_str(incdirs_vec, sv_files_vec, check_ch)

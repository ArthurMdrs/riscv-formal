...
<wavelist version="3">
  ...
  <spacer/>
  <wave>
    <expr>wrapper.uut.ex_stage_i.mult_i.mulh_ready</expr>
    <label/>
    <radix/>
  </wave>
  <wave collapsed="true">
    <expr>wrapper.uut.ex_stage_i.mult_i.mulh_CS</expr>
    <label/>
    <radix>wrapper.uut.ex_stage_i.mult_i.mulh_CS</radix>
  </wave>
  <wave>
    <expr>wrapper.uut.ex_stage_i.mult_multicycle_o</expr>
    <label/>
    <radix/>
  </wave>
  <spacer/>

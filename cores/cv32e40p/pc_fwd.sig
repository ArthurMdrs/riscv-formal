...
<wavelist version="3">
  <insertion-point-position>51</insertion-point-position>
  <wave>
    <expr>clock</expr>
    <label/>
    <radix/>
  ...
  <group collapsed="false">
    ...
    <label>PC</label>
    <wave>
      <expr>wrapper.uut.next_is_intr</expr>
      <label/>
      <radix/>
    </wave>
    <wave collapsed="true">
    ...
    <wave collapsed="true">
      <expr>wrapper.uut.if_stage_i.fetch_addr_n</expr>
      <label/>
      <radix>checker_inst.expect_pc</radix>
    </wave>
    <wave collapsed="true">
  ...
  <group collapsed="false">
    ...
    <wave collapsed="true">
      <expr>wrapper.uut.rvfi_order_wb</expr>
      <label/>
      <radix/>
    </wave>
    <wave>

...
<wavelist version="3">
  ...
  <group collapsed="false">
    ...
    <label>Rs3</label>
    <wave collapsed="true">
      <expr>checker_inst.spec_rs3_addr</expr>
      <label/>
      <radix>checker_inst.rs3_addr</radix>
    </wave>
    <wave collapsed="true">
      <expr>wrapper.uut.rvfi_rs3_rdata_wb</expr>
      <label/>
      <radix>checker_inst.rvfi_rs1_rdata</radix>
    </wave>
    <wave collapsed="true">
      <expr>wrapper.uut.rvfi_rs3_addr_wb</expr>
      <label/>
      <radix>checker_inst.rs3_addr</radix>
    </wave>
    <wave collapsed="true">
      <expr>wrapper.uut.id_stage_i.regfile_addr_rc_id</expr>
      <label/>
      <radix>checker_inst.spec_rs3_addr</radix>
    </wave>
    <wave collapsed="true">
  ...
  <group collapsed="false">
    ...
    <wave collapsed="true">
      <expr>wrapper.uut.ex_stage_i.alu_i.operand_a_i</expr>
      <label/>
      <radix>checker_inst.rd_wdata</radix>
    </wave>
    <wave collapsed="true">
      <expr>wrapper.uut.ex_stage_i.alu_i.operand_b_i</expr>
      <label/>
      <radix>checker_inst.rd_wdata</radix>
    </wave>
    <wave collapsed="true">
      <expr>wrapper.uut.ex_stage_i.alu_i.operand_c_i</expr>
      <label/>
      <radix>checker_inst.rd_wdata</radix>
    </wave>
  </group>

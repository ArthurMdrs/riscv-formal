...
module rvfi_insn_cv_sdotup_sci_b (
  input                                 rvfi_valid,
...
`endif
  ...
  // CV_SDOTUP_SCI_B instruction
`ifdef RISCV_FORMAL_ALTOPS
  wire [31:0] op2 = {4{{2{1'b0}}, rvfi_insn[24:20], rvfi_insn[25]}};
...
`else
  ...
  always_comb
    for(int i = 0; i < 4; i++) begin
      ...
      op2[i] = {rvfi_insn[24:20], rvfi_insn[25]};
      res[i] = op1[i] * op2[i];
    end
  wire [31:0] res_sum = res[0] + res[1] + res[2] + res[3];
  wire [31:0] result = res_sum + rvfi_rs3_rdata;
`endif
  wire flag = 1'b1;
  assign spec_valid = rvfi_valid && !insn_padding && flag && insn_funct5 == 5'b1_0011 && insn_funct1 == 1'b0 && insn_funct3 == 3'b111 && insn_opcode == 7'b111_1011;

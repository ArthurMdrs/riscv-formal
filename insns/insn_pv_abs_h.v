...
`endif
  ...
  always_comb
    for(int i = 0; i < 2; i++) begin
      ...
      res[i] = ($signed(op1[i]) < 0) ? (-op1[i]) : (op1[i]);
    end
  wire [31:0] result = {res[1], res[0]};
  // ATTENTION!! The core does not check if rvfi_rs2 = 0!!!
  // This leads to it executing illegal instructions!!!
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct5 == 5'd14 && insn_funct1 == 1'b0 && insn_funct3 == 3'b000 && insn_opcode == 7'b101_0111 && insn_rs2 == 0;

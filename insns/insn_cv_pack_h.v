...
`endif
  ...
  // CV_PACK_H instruction
  int pos;
  reg [31:0] result;
  always_comb begin
      pos = 16;
      result[15: 0] = rvfi_rs2_rdata[pos +: 16];
      result[31:16] = rvfi_rs1_rdata[pos +: 16];
  end
  wire flag = rvfi_insn[25] == 1'b1;
  assign spec_valid = rvfi_valid && !insn_padding && flag && insn_funct5 == 5'b1_1110 && insn_funct1 == 1'b0 && insn_funct3 == 3'b000 && insn_opcode == 7'b111_1011;

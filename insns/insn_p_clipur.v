...
`endif
  ...
  // P_CLIPUR instruction
  reg signed [31:0] compl = 0;
  reg signed [31:0] compg;
  always_comb
    begin
      compg = rvfi_rs2_rdata;
    end
  ...
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct7 == 7'b000_1010 && insn_funct3 == 3'b110 && insn_opcode == 7'b011_0011;

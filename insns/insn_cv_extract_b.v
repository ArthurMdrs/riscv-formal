...
`endif
  ...
  // CV_EXTRACT_B instruction
  wire [ 1:0] sel = {rvfi_insn[20], rvfi_insn[25]};
  wire [ 7:0] selected = rvfi_rs1_rdata[sel*8+:8];
  wire [31:0] result = {{24{selected[7]}}, selected};
  wire flag = rvfi_insn[24:21] == '0;
  assign spec_valid = rvfi_valid && !insn_padding && flag && insn_funct5 == 5'b1_0111 && insn_funct1 == 1'b0 && insn_funct3 == 3'b001 && insn_opcode == 7'b111_1011;

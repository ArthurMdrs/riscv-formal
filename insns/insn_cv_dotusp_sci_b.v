...
module rvfi_insn_cv_dotusp_sci_b (
  input                                 rvfi_valid,
...
`endif
  wire flag = 1'b1;
  assign spec_valid = rvfi_valid && !insn_padding && flag && insn_funct5 == 5'b1_0001 && insn_funct1 == 1'b0 && insn_funct3 == 3'b111 && insn_opcode == 7'b111_1011;

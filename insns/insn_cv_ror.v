...
`endif
  ...
  wire [31:0] result = rvfi_rs1_rdata << (32-shamt) | rvfi_rs1_rdata >> shamt;
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct7 == 7'b010_0000 && insn_funct3 == 3'b011 && insn_opcode == 7'b010_1011;

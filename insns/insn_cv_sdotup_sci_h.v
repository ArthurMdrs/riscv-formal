...
module rvfi_insn_cv_sdotup_sci_h (
  input                                 rvfi_valid,
...
`endif
  ...
  // CV_SDOTUP_SCI_H instruction
`ifdef RISCV_FORMAL_ALTOPS
  wire [31:0] op2 = {2{{10{1'b0}}, rvfi_insn[24:20], rvfi_insn[25]}};
...
`endif
  wire flag = 1'b1;
  assign spec_valid = rvfi_valid && !insn_padding && flag && insn_funct5 == 5'b1_0011 && insn_funct1 == 1'b0 && insn_funct3 == 3'b110 && insn_opcode == 7'b111_1011;

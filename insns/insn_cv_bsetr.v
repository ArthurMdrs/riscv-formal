...
`endif
  ...
  wire [31:0] rs1_masked = rvfi_rs1_rdata | mask_sh;	// rs1[ls2+ls3 : ls2] = '1
  wire [31:0] res_u      = rs1_masked;

  wire [31:0] result = res_u;
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct7 == 7'b001_1101 && insn_funct3 == 3'b011 && insn_opcode == 7'b010_1011;

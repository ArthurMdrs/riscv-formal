...
module rvfi_insn_cv_cplxmul_i_div2 (
  input                                 rvfi_valid,
...
`else
  ...
  assign result[31:16] = $signed(product) >>> 16;
  assign result[15: 0] = rvfi_rs3_rdata[15: 0];
`endif
  wire flag = rvfi_insn[25] == 1'b1;
  assign spec_valid = rvfi_valid && !insn_padding && flag && insn_funct5 == 5'b0_1010 && insn_funct1 == 1'b1 && insn_funct3 == 3'b010 && insn_opcode == 7'b111_1011;

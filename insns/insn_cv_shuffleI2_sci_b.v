...
module rvfi_insn_cv_shuffleI2_sci_b (
  input                                 rvfi_valid,
...
`endif
  ...
  // CV_SHUFFLEI2_SCI_B instruction
  ...
  wire flag = 1'b1;
  assign spec_valid = rvfi_valid && !insn_padding && flag && insn_funct5 == 5'b1_1010 && insn_funct1 == 1'b0 && insn_funct3 == 3'b111 && insn_opcode == 7'b111_1011;

...
module rvfi_insn_pv_extractu_b (
  input                                 rvfi_valid,
...
`endif
  ...
  // PV_EXTRACTU_B instruction
  wire [ 1:0] imm    = {rvfi_insn[20], rvfi_insn[25]};
  wire [31:0] result = rvfi_rs1_rdata[imm*8 +: 8];
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct5 == 5'd18 && insn_funct1 == 1'b0 && insn_funct3 == 3'b111 && insn_opcode == 7'b101_0111;

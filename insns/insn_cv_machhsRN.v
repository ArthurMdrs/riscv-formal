...
`endif
  ...
  // CV_MACHHSRN instruction
  wire [4:0] insn_rs3 = insn_rd;
  wire [31:0] op1 = {{16{rvfi_rs1_rdata[31]}}, rvfi_rs1_rdata[31:16]};
  wire [31:0] op2 = {{16{rvfi_rs2_rdata[31]}}, rvfi_rs2_rdata[31:16]};
`ifdef RISCV_FORMAL_ALTOPS
  wire [31:0] altops_bitmask = 64'hd13db50d949ce5e8;
  wire [31:0] result = (((op1 + op2) & rvfi_rs3_rdata) >> insn_ls3) ^ altops_bitmask;
`else
  wire [31:0] result = $signed(op1 * op2 + rvfi_rs3_rdata + (1 << (insn_ls3 - 1))) >>> insn_ls3;
`endif
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct2 == 2'b11 && insn_funct3 == 3'b110 && insn_opcode == 7'b101_1011;

...
`endif
  ...
  always @(*) begin
    if (insn_opcode == 7'b 000_1011) begin
      funct3_valid = (insn_funct3 == 3'b111) || (insn_funct3 == 3'b001);
      funct7_valid = (insn_funct3 == 3'b111) ? (insn_funct7 == 7'b000_1000) : (1'b1);
    end
    else if (insn_opcode == 7'b 000_0011) begin
      funct3_valid = (insn_funct3 == 3'b111);
      funct7_valid = (insn_funct7 == 7'b000_1000);
    end
    else begin
      funct3_valid = 1'b0;
      funct7_valid = 1'b0;

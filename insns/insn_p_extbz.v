...
`endif
  ...
  // P_EXTBZ instruction
  wire [31:0] result = {24'b0, rvfi_rs1_rdata[7:0]};
  // ATTENTION!! The core does not check if rs2 = 0!!!
  // This leads to it executing illegal instructions!!!
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct7 == 7'b000_1000 && insn_funct3 == 3'b111 && insn_opcode == 7'b011_0011 && insn_rs2 == 5'b0;

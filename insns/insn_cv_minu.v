...
`endif
  ...
  // CV_MINU instruction
  wire [31:0] result = (rvfi_rs1_rdata < rvfi_rs2_rdata) ? (rvfi_rs1_rdata) : (rvfi_rs2_rdata);
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct7 == 7'b010_1100 && insn_funct3 == 3'b011 && insn_opcode == 7'b010_1011;

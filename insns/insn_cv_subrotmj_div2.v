...
module rvfi_insn_cv_subrotmj_div2 (
  input                                 rvfi_valid,
...
`endif
  ...
  wire [31:0] result;
  assign result[31:16] = $signed(res_im) >>> 1;
  assign result[15: 0] = $signed(res_re) >>> 1;
  wire flag = rvfi_insn[25] == 1'b0;
  assign spec_valid = rvfi_valid && !insn_padding && flag && insn_funct5 == 5'b0_1100 && insn_funct1 == 1'b1 && insn_funct3 == 3'b010 && insn_opcode == 7'b111_1011;

...
`endif
  ...
  // PV_INSERT_H instruction
  wire        imm       = rvfi_insn[25];
  wire [31:0] rd_masked = rvfi_rs3_rdata & ~(32'hFFFF << imm*16);
  wire [31:0] rs1_slice = rvfi_rs1_rdata[15:0] << imm*16;
  wire [31:0] result    = rd_masked | rs1_slice;
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct5 == 5'd22 && insn_funct1 == 1'b0 && insn_funct3 == 3'b110 && insn_opcode == 7'b101_0111;

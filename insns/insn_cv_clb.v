...
`endif
  ...
  always_comb begin
    ...
    for(int i = 31; i >= 0; i--)
      if(i != 0) begin
        if(rvfi_rs1_rdata[i] != rvfi_rs1_rdata[i-1])
          break;
        else
        result++;
      end
  end
  assign spec_valid = rvfi_valid && !insn_padding && !insn_rs2 && insn_funct7 == 7'b010_0011 && insn_funct3 == 3'b011 && insn_opcode == 7'b010_1011;

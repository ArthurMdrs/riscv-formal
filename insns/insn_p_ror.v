...
`endif
  ...
  wire [`RISCV_FORMAL_XLEN-1:0] result = rvfi_rs1_rdata << (32-shamt) | rvfi_rs1_rdata >> shamt;
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct7 == 7'b 000_0100 && insn_funct3 == 3'b 101 && insn_opcode == 7'b 0110011;

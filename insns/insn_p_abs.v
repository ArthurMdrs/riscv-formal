...
`endif
  ...
  // P_ABS instruction
  wire [31:0] result = ($signed(rvfi_rs1_rdata) < 0) ? (-rvfi_rs1_rdata) : (rvfi_rs1_rdata);
  // ATTENTION!! The core does not check if rs2 = 0!!!
  // This leads to it executing illegal instructions!!!
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct7 == 7'b000_0010 && insn_funct3 == 3'b000 && insn_opcode == 7'b011_0011 && insn_rs2 == 5'b0;

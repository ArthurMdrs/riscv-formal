...
`endif
  ...
  always @(*) begin
    ...
    if (insn_funct3[1:0] == 2'b11) begin
      if (insn_funct7[6:3] == 4'b001_0 && insn_funct7[1:0] == 2'b01)
        funct7_valid = 1'b1;
    end
    else begin
      funct7_valid = 1'b1;
    ...
    if (insn_funct3 inside {3'b011, 3'b001})
      funct3_valid = 1'b1;
  end

  wire [`RISCV_FORMAL_XLEN-1:0] op2 = (insn_funct3[1:0] == 2'b11) ? (rvfi_rs3_rdata) : (insn_imm);
  ...
  assign spec_valid = rvfi_valid && !insn_padding && funct3_valid && funct7_valid && insn_opcode == 7'b010_1011;
  assign spec_rs1_addr = insn_rs1;
  assign spec_rs2_addr = insn_rs2;
  assign spec_rs3_addr = (insn_funct3[1:0] == 2'b11) ? (insn_rs3) : ('0);

...
`endif
  ...
  // CV_BCLRR instruction

  wire [4:0] insn_ls2 = rvfi_rs2_rdata[4:0];
  wire [4:0] insn_ls3 = rvfi_rs2_rdata[9:5];

  // Clear rs1[ls2+ls3 : ls2]
  wire [31:0] mask       = (2 << insn_ls3) - 1;		// mask[    ls3 :   0] = '1
  wire [31:0] mask_sh    = mask << insn_ls2;		// mask[ls2+ls3 : ls2] = '1
  // Documentation for this instruction is a bit unclear, but this is the intended result
  wire [31:0] rs1_masked = rvfi_rs1_rdata & ~mask_sh;	// rs1[ls2+ls3 : ls2] = '0
  wire [31:0] res_u      = rs1_masked;

  wire [31:0] result = res_u;
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct7 == 7'b001_1100 && insn_funct3 == 3'b011 && insn_opcode == 7'b010_1011;

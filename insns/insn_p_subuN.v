...
`endif
  ...
  // P_SUBUN instruction
  wire [31:0] result = (rvfi_rs1_rdata - rvfi_rs2_rdata) >> insn_ls3;
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct2 == 2'b10 && insn_funct3 == 3'b011 && insn_opcode == 7'b101_1011;

...
`endif
  ...
  wire [31:0] result = $signed(rvfi_rs3_rdata - rvfi_rs1_rdata) >>> rvfi_rs2_rdata[4:0];
  // ATTENTION!! The core does not check if ls3 = 0!!!
  // This leads to it executing illegal instructions!!!
  // Correct spec_valid: rvfi_valid && !insn_padding && insn_funct2 == 2'b01 && insn_funct3 == 3'b011 && insn_opcode == 7'b101_1011 && insn_ls3 == 5'b0
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct2 == 2'b01 && insn_funct3 == 3'b011 && insn_opcode == 7'b101_1011;

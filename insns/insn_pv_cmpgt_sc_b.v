...
module rvfi_insn_pv_cmpgt_sc_b (
  input                                 rvfi_valid,
...
`endif
  ...
  // Correct spec_valid: rvfi_valid && !insn_padding && insn_funct5 == 5'd2 && insn_funct1 == 1'b1 && insn_funct3 == 3'b101 && insn_opcode == 7'b101_0111 && rvfi_insn[25] == 1'b0
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct5 == 5'd2 && insn_funct1 == 1'b1 && insn_funct3 == 3'b101 && insn_opcode == 7'b101_0111;

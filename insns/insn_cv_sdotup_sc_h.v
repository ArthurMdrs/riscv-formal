...
module rvfi_insn_cv_sdotup_sc_h (
  input                                 rvfi_valid,
...
`endif
  ...
  assign spec_valid = rvfi_valid && !insn_padding && flag && insn_funct5 == 5'b1_0011 && insn_funct1 == 1'b0 && insn_funct3 == 3'b100 && insn_opcode == 7'b111_1011;

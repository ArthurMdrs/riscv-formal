...
`endif
  ...
  // CV_SLET instruction
  wire [31:0] result = ($signed(rvfi_rs1_rdata) <= $signed(rvfi_rs2_rdata)) ? (1) : (0);
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct7 == 7'b010_1001 && insn_funct3 == 3'b011 && insn_opcode == 7'b010_1011;

...
`endif
  ...
  // PV_INSERT_B instruction
  wire [ 1:0] imm       = {rvfi_insn[20], rvfi_insn[25]};
  wire [31:0] rd_masked = rvfi_rs3_rdata & ~(32'hFF << imm*8);
  wire [31:0] rs1_slice = rvfi_rs1_rdata[7:0] << imm*8;
  wire [31:0] result    = rd_masked | rs1_slice;
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct5 == 5'd22 && insn_funct1 == 1'b0 && insn_funct3 == 3'b111 && insn_opcode == 7'b101_0111;

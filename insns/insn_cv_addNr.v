...
`endif
  ...
  // CV_ADDNR instruction
  wire [31:0] result = $signed(rvfi_rs1_rdata + rvfi_rs3_rdata) >>> rvfi_rs2_rdata[4:0];
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct7 == 7'b100_0000 && insn_funct3 == 3'b011 && insn_opcode == 7'b010_1011;

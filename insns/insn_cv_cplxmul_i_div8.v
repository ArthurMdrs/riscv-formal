...
module rvfi_insn_cv_cplxmul_i_div8 (
  input                                 rvfi_valid,
...
`endif
  ...
  // CV_CPLXMUL_I_DIV8 instruction
`ifdef RISCV_FORMAL_ALTOPS
  wire [31:0] altops_bitmask = 64'hea3969edecfbe137;
  wire [31:0] result = ((rvfi_rs1_rdata - rvfi_rs2_rdata) | rvfi_rs3_rdata) ^ altops_bitmask;
`else
  wire [31:0] result;
  wire [15:0] rs1_re = rvfi_rs1_rdata[15: 0];
  wire [15:0] rs1_im = rvfi_rs1_rdata[31:16];
  wire [15:0] rs2_re = rvfi_rs2_rdata[15: 0];
  wire [15:0] rs2_im = rvfi_rs2_rdata[31:16];
  wire [31:0] product = $signed(rs1_re)*$signed(rs2_im) + $signed(rs1_im)*$signed(rs2_re);
  assign result[31:16] = $signed(product) >>> 18;
  assign result[15: 0] = rvfi_rs3_rdata[15: 0];
`endif
  wire flag = rvfi_insn[25] == 1'b1;
  assign spec_valid = rvfi_valid && !insn_padding && flag && insn_funct5 == 5'b0_1010 && insn_funct1 == 1'b1 && insn_funct3 == 3'b110 && insn_opcode == 7'b111_1011;

...
module rvfi_insn_cv_sdotusp_sc_h (
  input                                 rvfi_valid,
...
`endif
  ...
  // CV_SDOTUSP_SC_H instruction
`ifdef RISCV_FORMAL_ALTOPS
  wire [31:0] op2 = {2{rvfi_rs2_rdata[15:0]}};
...
`endif
  ...
  assign spec_valid = rvfi_valid && !insn_padding && flag && insn_funct5 == 5'b1_0100 && insn_funct1 == 1'b0 && insn_funct3 == 3'b100 && insn_opcode == 7'b111_1011;

...
`endif
  ...
  assign spec_valid = rvfi_valid && !insn_padding && flag && insn_funct5 == 5'b0_0000 && insn_funct1 == 1'b1 && insn_funct3 == 3'b000 && insn_opcode == 7'b111_1011;

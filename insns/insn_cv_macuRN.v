...
`endif
  ...
  // CV_MACURN instruction
  wire [4:0] insn_rs3 = insn_rd;
  wire [31:0] op1 = {16'b0, rvfi_rs1_rdata[15:0]};
  wire [31:0] op2 = {16'b0, rvfi_rs2_rdata[15:0]};
`ifdef RISCV_FORMAL_ALTOPS
  wire [31:0] altops_bitmask = 64'hea3969edecfbe137;
  wire [31:0] result = (((op1 + op2) & rvfi_rs3_rdata) >> insn_ls3) ^ altops_bitmask;
`else
  wire [31:0] result = (op1 * op2 + rvfi_rs3_rdata + (1 << (insn_ls3 - 1))) >> insn_ls3;
`endif
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct2 == 2'b10 && insn_funct3 == 3'b111 && insn_opcode == 7'b101_1011;

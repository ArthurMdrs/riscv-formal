...
module rvfi_insn_cv_cplxmul_r_div2 (
  input                                 rvfi_valid,
...
`endif
  ...
  // CV_CPLXMUL_R_DIV2 instruction
`ifdef RISCV_FORMAL_ALTOPS
  wire [31:0] altops_bitmask = 64'hd13db50d949ce5e8;
...
`else
  ...
  wire [31:0] product = $signed(rs1_re)*$signed(rs2_re) - $signed(rs1_im)*$signed(rs2_im);
  assign result[31:16] = rvfi_rs3_rdata[31:16];
  assign result[15: 0] = $signed(product) >>> 16;
`endif

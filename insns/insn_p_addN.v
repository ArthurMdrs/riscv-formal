...
`endif
  ...
  // P_ADDN instruction
  wire [31:0] result = $signed(rvfi_rs1_rdata + rvfi_rs2_rdata) >>> insn_ls3;
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct2 == 2'b00 && insn_funct3 == 3'b010 && insn_opcode == 7'b101_1011;

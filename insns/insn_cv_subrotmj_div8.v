...
module rvfi_insn_cv_subrotmj_div8 (
  input                                 rvfi_valid,
...
`endif
  ...
  wire [15:0] res_re;
  wire [15:0] res_im;
  assign res_im = rs2_re - rs1_re;
  assign res_re = rs1_im - rs2_im;
  wire [31:0] result;
  assign result[31:16] = $signed(res_im) >>> 3;
  assign result[15: 0] = $signed(res_re) >>> 3;
  wire flag = rvfi_insn[25] == 1'b0;
  assign spec_valid = rvfi_valid && !insn_padding && flag && insn_funct5 == 5'b0_1100 && insn_funct1 == 1'b1 && insn_funct3 == 3'b110 && insn_opcode == 7'b111_1011;

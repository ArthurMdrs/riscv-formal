...
`endif
  ...
  // CV_CPLXCONJ instruction
  wire [31:0] result;
  assign result[31:16] = - rvfi_rs1_rdata[31:16];
  assign result[15: 0] = rvfi_rs1_rdata[15: 0];
  wire flag = rvfi_insn[25:20] == 6'b0;
  assign spec_valid = rvfi_valid && !insn_padding && flag && insn_funct5 == 5'b0_1011 && insn_funct1 == 1'b1 && insn_funct3 == 3'b000 && insn_opcode == 7'b111_1011;

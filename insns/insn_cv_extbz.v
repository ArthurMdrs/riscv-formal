...
`endif
  ...
  // CV_EXTBZ instruction
  wire [31:0] result = {24'b0, rvfi_rs1_rdata[7:0]};
  assign spec_valid = rvfi_valid && !insn_padding && !insn_rs2 && insn_funct7 == 7'b011_0011 && insn_funct3 == 3'b011 && insn_opcode == 7'b010_1011;

...
module rvfi_insn_pv_cmple_sci_b (
  input                                 rvfi_valid,
...
`endif
  ...
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct5 == 5'd5 && insn_funct1 == 1'b1 && insn_funct3 == 3'b111 && insn_opcode == 7'b101_0111;

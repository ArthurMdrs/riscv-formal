...
`endif
  ...
  // CV_MACSRN instruction
  wire [4:0] insn_rs3 = insn_rd;
  wire [31:0] op1 = {{16{rvfi_rs1_rdata[15]}}, rvfi_rs1_rdata[15:0]};
  wire [31:0] op2 = {{16{rvfi_rs2_rdata[15]}}, rvfi_rs2_rdata[15:0]};
...
`endif
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct2 == 2'b10 && insn_funct3 == 3'b110 && insn_opcode == 7'b101_1011;

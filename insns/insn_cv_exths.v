...
`endif
  ...
  // CV_EXTHS instruction
  wire [31:0] result = {{16{rvfi_rs1_rdata[15]}}, rvfi_rs1_rdata[15:0]};
  assign spec_valid = rvfi_valid && !insn_padding && !insn_rs2 && insn_funct7 == 7'b011_0000 && insn_funct3 == 3'b011 && insn_opcode == 7'b010_1011;

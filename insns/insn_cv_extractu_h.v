...
module rvfi_insn_cv_extractu_h (
  input                                 rvfi_valid,
...
`endif
  ...
  // CV_EXTRACTU_H instruction
  wire        sel = rvfi_insn[25];
  wire [15:0] selected = rvfi_rs1_rdata[sel*16+:16];
  wire [31:0] result = {16'b0, selected};
  wire flag = rvfi_insn[24:20] == '0;
  assign spec_valid = rvfi_valid && !insn_padding && flag && insn_funct5 == 5'b1_0111 && insn_funct1 == 1'b0 && insn_funct3 == 3'b010 && insn_opcode == 7'b111_1011;

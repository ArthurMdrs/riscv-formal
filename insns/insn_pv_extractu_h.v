...
module rvfi_insn_pv_extractu_h (
  input                                 rvfi_valid,
...
`endif
  ...
  // PV_EXTRACTU_H instruction
  wire        imm    = rvfi_insn[25];
  wire [31:0] result = rvfi_rs1_rdata[imm*16 +: 16];
  assign spec_valid = rvfi_valid && !insn_padding && insn_funct5 == 5'd18 && insn_funct1 == 1'b0 && insn_funct3 == 3'b110 && insn_opcode == 7'b101_0111;

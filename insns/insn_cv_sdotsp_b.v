...
`endif
  ...
  assign spec_valid = rvfi_valid && !insn_padding && flag && insn_funct5 == 5'b1_0101 && insn_funct1 == 1'b0 && insn_funct3 == 3'b001 && insn_opcode == 7'b111_1011;
